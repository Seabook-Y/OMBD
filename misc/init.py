...
def parse_args():
    ...
    parser.add_argument('--exp_name', default='OMBDPDMB')

    # please adjust the path
    parser.add_argument('--data_root', default='./data/PDMB')
    parser.add_argument('--dataset_file', type=str, default='./data/PDMB/data_info.json')
    parser.add_argument('--KF', type=str, default='./data/PDMB/KF.pickle')
    parser.add_argument('--checkpoint', type=str, default='./checkpoint/PDMB-TSN-Kinetics.pth')
    ...
    parser.add_argument('--numclass', default=9, type=int)
